...
% @ String(label="Offset Choice", choices={"File", "Value"}, style="radioButtonHorizontal") OffsetChoice
...
% @ String(label="Gain Choice", choices={"File", "Value"}, style="radioButtonHorizontal") GainChoice
